...
#
# Copyright (c) 2002-2006,2023,2025 by Landon Curt Noll.  All Rights Reserved.
#
...
entropy_01.o: entropy_01.c
	${CC} ${CFLAGS} entropy_01.c -c

entropy_01: entropy_01.o
	${CC} ${CFLAGS} entropy_01.o -o $@
